...
def test_solver():
    ...
    fd_solver = MSEMpy(
        1.55,  # Set the wavelength of choice
        0.46,  # Define the width of the waveguide
        0.22,  # Define the thickness of the waveguide
        mesh=128,  # Set the mesh density
        num_modes=1,  # Set the number of modes to solve for
        cladding_width=2.5,  # Define the cladding width (default is same as ANN)
        cladding_thickness=2.5,  # Define the cladding thickness (default is same as ANN)
