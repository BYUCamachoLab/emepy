...
# from emepy.tools import from_chunks, get_epsfunc, Si, SiO2
...
#         epsfunc = get_epsfunc(self.width, self.thickness, 2.5e-6, 2.5e-6, Si(self.wl * 1e6), SiO2(self.wl * 1e6))
#         n = epsfunc(self.x, self.y)
#         m = Mode(self.x, self.y, self.wl, neff, Hx + 0j, Hy + 0j, None, None, None, None, n)
#         m.compute_other_fields(epsfunc)
#         m.normalize()
...
class MSNeuralNetwork(ModeSolver):
    ...
    def get_mode(self, mode_num=0):
        ...
        m = Mode(self.x, self.y, self.wl, neff, Hx + 0j, Hy + 0j, None, None, None, None, epsfunc_after(self.x, self.y))
